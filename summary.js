...
const summarize=async (article) => {
  ...
  await openaiCompletion(messages(`You are a financial analyst, please summarize this article without missing any numbers. Be sure not to omit any of the numbers mentioned in the article. Never miss any numbers in the article. The summary can be very long.  Article: ${article}`));
